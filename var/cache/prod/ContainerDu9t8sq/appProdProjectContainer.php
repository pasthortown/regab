...
class appProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'autowired.appbundle\\entity\\establecimiento' => 'autowired.AppBundle\\Entity\\Establecimiento',
        ...
        $this->fileMap = array(
            ...
            'app_api.event.jwt_created_listener' => 'getAppApi_Event_JwtCreatedListenerService.php',
            ...
            'autowired.AppBundle\\Entity\\Establecimiento' => 'getEstablecimientoService.php',
            ...
            'security.request_matcher.bmeysob' => 'getSecurity_RequestMatcher_BmeysobService.php',
            'security.user.provider.concrete.api_user_provider' => 'getSecurity_User_Provider_Concrete_ApiUserProviderService.php',
            ...
            'service_locator.bum7w2o' => 'getServiceLocator_Bum7w2oService.php',
            'service_locator.ox36r6b' => 'getServiceLocator_Ox36r6bService.php',
            ...
            'vich_uploader.metadata_reader' => 'getVichUploader_MetadataReaderService.php',
            ...
            'vich_uploader.namer_uniqid.anexos' => 'getVichUploader_NamerUniqid_AnexosService.php',
            'vich_uploader.property_mapping_factory' => 'getVichUploader_PropertyMappingFactoryService.php',
            'vich_uploader.storage' => 'getVichUploader_StorageService.php',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', array(0 => function () {
            return ${($_ = isset($this->services['app_api.event.jwt_created_listener']) ? $this->services['app_api.event.jwt_created_listener'] : $this->load('getAppApi_Event_JwtCreatedListenerService.php')) && false ?: '_'};
        }, 1 => 'onJWTCreated'), 0);
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(array('security.firewall.map.context.api' => function () {
            ...
            yield 'security.firewall.map.context.login' => ${($_ = isset($this->services['security.request_matcher.0zajqpr']) ? $this->services['security.request_matcher.0zajqpr'] : $this->services['security.request_matcher.0zajqpr'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/auth/login')) && false ?: '_'};
            yield 'security.firewall.map.context.api' => ${($_ = isset($this->services['security.request_matcher.bmeysob']) ? $this->services['security.request_matcher.bmeysob'] : $this->services['security.request_matcher.bmeysob'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/api/v1')) && false ?: '_'};
        ...
        switch ($name) {
            ...
            case 'vich_uploader.mappings': $value = array(
                'anexos' => array(
                    ...
                    'upload_destination' => ($this->targetDirs[3].'/web/uploads/anexos'),
                    'namer' => array(
                        'service' => 'vich_uploader.namer_uniqid.anexos',
                        'options' => array(
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => '192.168.20.20',
            'database_port' => 3306,
            'database_name' => 'registroab',
            'database_user' => 'registroab',
            'database_password' => 'reg1str0.abl23',
            ...
            'lexik_jwt_authentication.pass_phrase' => 'secret',
