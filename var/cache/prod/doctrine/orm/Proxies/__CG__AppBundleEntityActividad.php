...
class Actividad extends \AppBundle\Entity\Actividad implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Actividad' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Actividad' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Actividad' . "\0" . 'sigla', '' . "\0" . 'AppBundle\\Entity\\Actividad' . "\0" . 'secuencial', '' . "\0" . 'AppBundle\\Entity\\Actividad' . "\0" . 'version'];
        }
