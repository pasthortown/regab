 ...
 */
class Canton extends \AppBundle\Entity\Canton implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Canton' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Canton' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\Canton' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Canton' . "\0" . 'sigla', '' . "\0" . 'AppBundle\\Entity\\Canton' . "\0" . 'anio', '' . "\0" . 'AppBundle\\Entity\\Canton' . "\0" . 'provincia'];
        }
