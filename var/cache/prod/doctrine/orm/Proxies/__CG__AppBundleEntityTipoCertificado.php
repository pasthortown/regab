 ...
 */
class TipoCertificado extends \AppBundle\Entity\TipoCertificado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TipoCertificado' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\TipoCertificado' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\TipoCertificado' . "\0" . 'categoria', '' . "\0" . 'AppBundle\\Entity\\TipoCertificado' . "\0" . 'establecimientos'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoCertificado $proxy) {
    ...
    public function addEstablecimiento(\AppBundle\Entity\Establecimiento $establecimiento)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEstablecimiento', [$establecimiento]);

        return parent::addEstablecimiento($establecimiento);
    }
