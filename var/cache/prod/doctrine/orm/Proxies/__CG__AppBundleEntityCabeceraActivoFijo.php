 ...
 */
class CabeceraActivoFijo extends \AppBundle\Entity\CabeceraActivoFijo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\CabeceraActivoFijo' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\CabeceraActivoFijo' . "\0" . 'total', '' . "\0" . 'AppBundle\\Entity\\CabeceraActivoFijo' . "\0" . 'anio', '' . "\0" . 'AppBundle\\Entity\\CabeceraActivoFijo' . "\0" . 'establecimiento', '' . "\0" . 'AppBundle\\Entity\\CabeceraActivoFijo' . "\0" . 'anexo', 'createdAt', 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CabeceraActivoFijo $proxy) {
