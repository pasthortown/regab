 ...
 */
class Parroquia extends \AppBundle\Entity\Parroquia implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Parroquia' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Parroquia' . "\0" . 'codigo', '' . "\0" . 'AppBundle\\Entity\\Parroquia' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Parroquia' . "\0" . 'anio', '' . "\0" . 'AppBundle\\Entity\\Parroquia' . "\0" . 'canton'];
        }
